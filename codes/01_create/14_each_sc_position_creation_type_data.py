...
from codes.01_create.position_processors import SCPositionProcessor
...
if __name__ == "__main__":
    ...
    for pool_addr in tqdm(pool_addrs):
        processor = SCPositionProcessor(pool_addr, debug=True)
    ...
    # Save results
    output_path = os.path.join(get_parent(), "data", "raw", "pkl", "sc_position_metrics.pkl")
